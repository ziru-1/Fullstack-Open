...
const CreateNew = (props) => {
  const { handleFieldReset: resetContent, ...content } = useField('text')
  const { handleFieldReset: resetAuthor, ...author } = useField('text')
  const { handleFieldReset: resetInfo, ...info } = useField('text')
